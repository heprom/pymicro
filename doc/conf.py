...
import sys, os
import mock
MOCK_MODULES = ['numpy', 'scipy', 'scipy.special', 'matplotlib', 'matplotlib.pyplot', 'matplotlib.image', 'matplotlib.cm', 'matplotlib.colors', 'scipy.ndimage', 'wx', 'wx.Panel', 'vtk', 'vtk.util', 'vtk.util.colors', '_tifffile'] #, 'ImPanel', 'PlotPanel']
